...
#pragma warning restore 0414 
        ...
        public void OnDrawGizmos()
        {
            ...
            Gizmos.DrawSphere(_transientPosition + (_transientRotation * _characterTransformToCapsuleBottomHemi) - (_cachedWorldUp * GroundProbingBackstepDistance), 0.1025f);
            Gizmos.color = Color.red;    
            Gizmos.DrawSphere(_transientPosition + (_transientRotation * _characterTransformToCapsuleTopHemi) - (_cachedWorldUp * GroundProbingBackstepDistance), 0.1025f);
        }
    }
